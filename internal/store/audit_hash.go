...
// in docs/superpowers/plans/2026-05-29-ly-8b0-3-tamper-evident-audit-log.md.
// detail is the canonical JSON bytes of the row's JSONB column (zero
// length when SQL NULL). at is reduced to nanosecond UTC.
...
// lexicographically and no insignificant whitespace. Returns nil for a
// nil/empty input.
