...
// table (migrations/clickhouse/0010_logevents.sql). It mirrors the pgxStats
// logEventColumns order so the two backends stay in lockstep.
...
// zero is normalized to 1 (T1) on write, matching the pgxStats behaviour. Every
