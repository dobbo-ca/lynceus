...
>
> **Last updated:** 2026-06-08 · **Repo HEAD:** `main` @ `fa99c4a` (PR #19, Layer 0, merged) · **Layer 1 complete** on branch `worktree-layer1-engines-a3f1`, pending PR — 8 beads: `ly-u4t.1/.2/.3/.6/.8` EXPLAIN insights, `ly-u4t.12` Index Advisor, `ly-u4t.16` VACUUM Advisor, `ly-xqf.3` wait histograms; + follow-ups `ly-gu3` (docs), `ly-egn` (e2e wait-strategy + latent extraction bug), `ly-dfs` (log_events persistence).
...
| 2 | pganalyze parity | 🟡 **In progress** | M2–M6 epics; ~80 features in `docs/specs/2026-05-29-lynceus-features.md`. **Layer 0 merged** (PR #19: schema/table readers, insight+plan UI, capability gate, log source). **Layer 1 done** (this branch: 5 EXPLAIN insights, Index + VACUUM advisors, wait histograms). Layer 2 Checks/Alerts + Layer 3 log breadth + Workstream B (HA/perf) ahead. |
...
| M3 | `ly-u4t` | Collector-side analysis (EXPLAIN insights) | **Layer 1 done** — `ly-xqf.14` extraction + `ly-u4t.7` Slow Scan + `ly-hnt` surfacing ✅; **6 EXPLAIN insights ✅** (`.7` Slow Scan, `.1` Disk Sort, `.2` Hash Batches, `.3` Inefficient Index, `.6` Mis-Estimate, `.8` Stale Stats) + Index Advisor `.12` ✅ + VACUUM Advisor `.16` ✅. Remaining: Query-Advisor insights (`.4/.5/.9/.10/.11`), config tuning (`.18`), Layer-2 Checks (`.20`–`.27`, incl. `.21` Queries bundle) |
...
Done & merged on `main`: `ly-xqf.1`, `ly-xqf.14`, `ly-u4t.7`, `ly-8b0.3`, `ly-cxe.1`, `ly-xnk.1`, `ly-xnk.2`, and **PR #19** (Layer 0): `ly-xqf.5/.6/.10`, `ly-hnt`, `ly-xnk.3/.4`, `ly-cxe.2`. On branch `worktree-layer1-engines-a3f1` (pending PR, Layer 1): `ly-u4t.1/.2/.3/.6/.8/.12/.16`, `ly-xqf.3`, + `ly-gu3`/`ly-egn`/`ly-dfs`.
